...
def checkout(skus):
    ...
    if len(any_of_list):
        ...
        print(f'Offer applied for n_any_of_list_for_x {offer_applied_times} times')
        print(f'Total n of any count: {total_n_of_any_count}')
        ...
        print(f'Final sum after rest string: {final_sum}')
